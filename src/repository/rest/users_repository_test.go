...
func TestLoginUserTimeoutFromApi(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		URL:          "https://api.bookstore.com/users/loging",
...
func TestLoginUserInvalidLoginCredentials(t *testing.T) {	rest.FlushMockups()
  rest.AddMockups(&rest.Mock{
    HTTPMethod:   http.MethodPost,
    URL:          "https://api.bookstore.com/users/loging",
    ReqBody:      `{"email: email@gmail.com", "password: password"}`,
...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
  rest.AddMockups(&rest.Mock{
    ...
    RespBody:     `{"id": "18", "first_name": "test_first_name", "last_name": "test last_name", "email": "test12345@gmail.com"}`,
  })
  repository := usersRepository{}
...
func TestLoginUserNoError(t *testing.T) {
  ...
  assert.EqualValues(t, 18, user.Id)
  assert.EqualValues(t, "test_first_name", user.FirstName)
  assert.EqualValues(t, "test_last_name", user.LastName)
  assert.EqualValues(t, "test12345@gmail.com", user.Email)
}
